...
const BlogCard = ({image, title}:Props) => {
    return (
        <div className={'bg-gray-100 rounded-lg overflow-hidden'}>
            <Image src={image} alt={title} width={300} height={206} className={'w-full'} />
            <div className={'p-6'}>
                <div className={'flex items-center justify-between'}>
                    ...
                    <div className={'flex items-center space-x-3'}>
                        ...
                        <p className={'font-semibold text-gray-800 text-sm'}>October 27, 2025</p>
                    </div>
                ...
                <button className={'relative inline-block mt-8 cursor-pointer group'}>
                    <span className={'inline-flex items-center gap-2 text-sm font-semibold tracking-[2px] uppercase text-[#1a1a1a] '}>READ MORE
                                        <FiArrowDownRight className={'text-[#b79d7b] text-xl transition-transform duration-300 group-hover:translate-x-1'} /></span>
